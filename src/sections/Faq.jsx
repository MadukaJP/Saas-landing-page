      ...
      <Element name="faq" className="relative">
        ...
        <div>
          ...
          <p className="body-1 max-lg:max-w-sm">
            Explore the answers to some of the most common questions below.
          </p>
        </div>
        ...
        <div className="faq-glow_before relative z-2 border-2 border-s2 bg-s1">
            <div className="container flex gap-10 max-lg:block">
                ...
                z-4 flex size-20 items-center justify-center border-2 border-s2 bg-s1">
                    <img src="/images/logo.svg" alt="logo" className="size-1/2"/>
                </div>
            ...
            <div className="faq-line_after absolute left-[50%] top-0 -z-1 h-full w-0.5 bg-s2 max-lg:hidden"/>
        </div>
      </Element>
    </section>
  );
