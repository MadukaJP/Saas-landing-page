export const features = [
    {
      ...
      title: "Create effortlessly with AURA AI",
      text: "With AURA AI, creating stunning visuals is no longer a challenge. Automated features and intuitive workflows elevate your creative process, giving you more time to focus on what matters.",
      button: {
    ...
    },
    {
      ...
      title: "Trust AURA with your creativity",
      text: "Your projects are protected with AURA's advanced security systems. Rest easy knowing that your creative work is backed by cutting-edge encryption and privacy protocols.",
      button: {
 ...
 export const details = [
  ...
  },
  {
    ...
    title: "Blazing-Fast Cloud Processing",
  },
  {
    id: "3",
...
export const plans = [
  {
    ...
    priceMonthly: 15, 
    priceYearly: 120,  
    caption: "Perfect for individual creators",
    features: [
      "100MB Cloud storage",
  ...
  },
  {
    ...
    priceMonthly: 65, 
    priceYearly: 590, 
    caption: "Best for expanding teams",
    features: [
      "Includes all Solo features",
      "1TB additional cloud storage",
  ...
  },
  {
    ...
    priceMonthly: 45, 
    priceYearly: 400, 
    caption: "Designed for team synergy",
    features: [
...
export const faq = [
  {
    id: "0",
    question: "What is AURA AI and how does it generate photos?",
    answer: "AURA AI is an advanced artificial intelligence platform designed for photo generation. It uses deep learning algorithms and generative models to create unique, high-quality images based on text descriptions or other input parameters provided by users."
  },
  {
    id: "1",
    question: "How realistic are the images generated by AURA AI?",
    answer: "AURA AI produces highly realistic images. The level of realism can vary depending on the complexity of the request and the specific style chosen. Our AI is trained on a vast dataset, allowing it to generate detailed and convincing images across various subjects and styles."
  },
  {
    id: "2",
    question: "Can I use AURA AI-generated images for commercial purposes?",
    answer: "Yes, images generated by AURA AI can be used for commercial purposes under our standard license. However, we recommend reviewing our detailed licensing terms for specific use cases and limitations. For high-volume commercial use, we offer custom licensing options."
  },
  {
    id: "3",
    question: "How does AURA AI handle copyrighted material in image generation?",
    answer: "AURA AI is designed to create original images and avoids direct replication of copyrighted material. However, users are responsible for ensuring their prompts don't infringe on existing copyrights. We provide guidelines to help users create prompts that result in unique, non-infringing images."
  },
  {
    id: "4",
    question: "Is there a limit to how many images I can generate with AURA AI?",
    answer: "The number of images you can generate depends on your subscription plan. Free accounts have a monthly limit, while paid plans offer higher or unlimited generation capabilities. Check our pricing page for detailed information on each plan's offerings."
  },
  {
    id: "5",
    question: "How often is AURA AI updated with new features or improved image quality?",
    answer: "We continuously work on improving AURA AI's capabilities. Major updates, including new features and significant improvements to image quality, are typically released quarterly. Minor enhancements and optimizations are rolled out more frequently, often on a weekly or bi-weekly basis."
  },
  {
    id: "6",
    question: "Can I edit or customize the images after AURA AI generates them?",
    answer: "Absolutely! While AURA AI generates high-quality images, we understand the need for customization. You can download the generated images and edit them using your preferred image editing software. We also offer basic in-platform editing tools for quick adjustments."
  },
  {
    id: "7",
    question: "Does AURA AI offer an API for integration into other applications?",
    answer: "Yes, we provide a robust API that allows developers to integrate AURA AI's photo generation capabilities into their own applications, websites, or services. Our API documentation includes detailed guides and examples to help you get started with the integration."
  },
  {
    id: "8",
    question: "What image formats and resolutions does AURA AI support?",
    answer: "AURA AI generates images in common formats including JPEG, PNG, and WEBP. We support a range of resolutions, with our standard output being 1024x1024 pixels. Higher resolutions up to 4096x4096 are available on select plans. The specific formats and resolutions available may vary based on your subscription tier."
  },
  {
    id: "9",
    question: "How does AURA AI ensure diversity and avoid bias in generated images?",
    answer: "We've trained AURA AI on a diverse dataset and implemented algorithms to promote inclusivity in image generation. Our team regularly audits and updates the system to minimize biases. Users can also specify diverse characteristics in their prompts to ensure representation. We're committed to continuous improvement in this area and welcome user feedback."
  },
];
...
export const testimonials = [
  {
    ...
    comment: "AURA AI has revolutionized our design process. The image quality is simply astounding!"
  },
  {
    id: "1",
    name: "Rahul Patel",
    role: "CreativeVisions",
    avatarUrl: "/images/testimonials/mark-erixon.png",
    comment: "I was amazed at how quickly AURA AI could bring my concepts to life. It's a game-changer for our creative team."
  },
  {
    id: "2",
    name: "Sophie Dubois",
    ...
    comment: "The versatility of AURA AI is incredible. From photorealistic images to abstract art, it does it all beautifully."
  },
  {
    id: "3",
    name: "Liam O'Connor",
    ...
    comment: "AURA AI's intuitive interface made it easy for our entire team to create stunning visuals, regardless of their design background."
  },
  {
    id: "4",
    name: "Yuki Tanaka",
    ...
    comment: "The speed at which AURA AI generates high-quality images has significantly accelerated our product development cycle."
  },
  {
    id: "5",
    ...
    comment: "AURA AI has opened up new realms of possibility for our app designs. It's like having a world-class artist on call 24/7."
  }
];
...
export const socials = [
  {
    ...
    url: "https://x.com/MadukaJohnpeter",
  },
  {
    id: "1",
    title: "Threads",
